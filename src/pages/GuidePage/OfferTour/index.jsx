      ...
      <div className='container'>
        ...
        <ul className='offer-tour__list'>
          <li className='offer-tour__list-item'>
            <div
              style={{ backgroundImage: `url(${imgGuide1})` }}
              className='offer-tour__img'
            ></div>
          ...
          <li className='offer-tour__list-item'>
            <div
              style={{ backgroundImage: `url(${imgGuide2})` }}
              className='offer-tour__img'
            ></div>
          ...
          <li className='offer-tour__list-item'>
            <div
              style={{ backgroundImage: `url(${imgGuide3})` }}
              className='offer-tour__img'
            ></div>
          ...
          <li className='offer-tour__list-item'>
            <div
              style={{ backgroundImage: `url(${imgGuide4})` }}
              className='offer-tour__img'
            ></div>
